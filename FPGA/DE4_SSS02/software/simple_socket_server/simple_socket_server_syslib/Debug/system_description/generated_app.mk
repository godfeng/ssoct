...
$(QUARTUS_PROJECT_DIR)/onchip_memory.hex: $(ELF)
	...
	elf2hex $(ELF) 0x05080000 0x50FCFFF --width=32 $(QUARTUS_PROJECT_DIR)/onchip_memory.hex --create-lanes=0

$(QUARTUS_PROJECT_DIR)/descriptor_memory.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x05101000 0x51017FF --width=32 $(QUARTUS_PROJECT_DIR)/descriptor_memory.hex --create-lanes=0
