...
set ipfs_ext vo
set hdl_ext v
if {[file exists fft91.$ipfs_ext]} {
        puts "Info: Found fft91.$ipfs_ext."
} else {
	puts "Warning: Could not find fft91.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME fft91_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.fft91_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE fft91.$ipfs_ext -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE fft91_tb.$hdl_ext -section_id tb -library work
