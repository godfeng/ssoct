...
the system library properties configuration page), NicheStack TCP/IP Stack will attempt 
...
in the terminal window of Nios II IDE), you can connect to it over a network by typing the 
