# -------------------------------------------------------------------------
#
# ALTMEMPHY v9.1 DDR2 SDRAM pin constraints script for ddr2
#
...
set mem_clk_n_TREAT_BIDIR_AS_OUTPUT "ON"
...
set mem_dq_INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION"
...
set mem_dqs_INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION"
...
set mem_dqsn_INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION"
...
if {[string match -nocase "HARDCOPY IV*" [get_global_assignment -name family]]} {
...
set_instance_assignment -name TREAT_BIDIR_AS_OUTPUT "${mem_clk_n_TREAT_BIDIR_AS_OUTPUT}" -to ${mem_clk_n_pin_name}[1]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[0]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[1]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[2]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[3]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[4]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[5]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[6]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[7]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[8]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[9]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[10]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[11]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[12]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[13]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[14]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[15]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[16]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[17]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[18]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[19]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[20]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[21]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[22]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[23]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[24]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[25]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[26]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[27]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[28]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[29]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[30]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[31]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[32]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[33]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[34]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[35]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[36]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[37]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[38]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[39]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[40]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[41]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[42]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[43]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[44]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[45]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[46]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[47]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[48]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[49]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[50]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[51]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[52]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[53]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[54]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[55]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[56]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[57]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[58]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[59]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[60]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[61]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[62]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dq_INPUT_TERMINATION}" -to ${mem_dq_pin_name}[63]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[0]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[0]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[1]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[1]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[2]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[2]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[3]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[3]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[4]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[4]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[5]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[5]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[6]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[6]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqs_INPUT_TERMINATION}" -to ${mem_dqs_pin_name}[7]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}[7]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[0]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[0]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[1]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[1]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[2]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[2]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[3]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[3]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[4]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[4]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[5]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[5]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[6]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[6]
...
set_instance_assignment -name INPUT_TERMINATION "${mem_dqsn_INPUT_TERMINATION}" -to ${mem_dqsn_pin_name}[7]
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}[7]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[32]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[33]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[34]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[35]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[36]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[37]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[38]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[39]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[40]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[41]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[42]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[43]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[44]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[45]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[46]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[47]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[48]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[49]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[50]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[51]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[52]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[53]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[54]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[55]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[56]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[57]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[58]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[59]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[60]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[61]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[62]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dq_pin_name}[63]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqs_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqs_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqs_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqs_pin_name}[7]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[2]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[3]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[7]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dm_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dm_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dm_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dm_pin_name}[7]
...
set_instance_assignment -name T11_DELAY 7 -to ${mem_dqs_pin_name}
