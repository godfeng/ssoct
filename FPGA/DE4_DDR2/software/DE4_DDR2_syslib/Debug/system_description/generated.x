 ...
 *
 * Generated: 2011-07-04 17:47:18.116
 *
 */
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  onchip_memory2 =0x3a880100 /* NOP on Nios2 (big endian) */
    ...
    .ddr2 : AT (LOADADDR (.onchip_memory2) + SIZEOF (.onchip_memory2))
    {
...
PROVIDE( __alt_heap_limit    = 0x41040000 );
