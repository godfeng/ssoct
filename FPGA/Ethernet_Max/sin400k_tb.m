...
% file : sin400k_tb.m
%
% Description : The following Matlab testbench excercises the NCO model sin400k_model.m
...
[sin_out,cos_out] = sin400k_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_sin400k_matlab.txt','w');
fid_c = fopen('fcos_o_sin400k_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
  fprintf(fid_c,'%f\n',cos_out(i));
end
