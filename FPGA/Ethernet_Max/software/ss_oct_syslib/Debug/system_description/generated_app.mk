...
#
# Generated: 2012-01-19 12:03:21.038
...
QUARTUS_PROJECT_DIR = D:/Edgar/Documents/ssoct/FPGA/Ethernet_Max
...
$(QUARTUS_PROJECT_DIR)/onchip_memory.hex: $(ELF)
	...
	elf2hex $(ELF) 0x49080000 0x490FCFFF --width=32 $(QUARTUS_PROJECT_DIR)/onchip_memory.hex --create-lanes=0

$(QUARTUS_PROJECT_DIR)/descriptor_memory.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x49101800 0x49101FFF --width=32 $(QUARTUS_PROJECT_DIR)/descriptor_memory.hex --create-lanes=0
...
$(EXT_FLASH_FLASHTARGET_ALT_SIM_PREFIX)ext_flash.flash: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2flash --input=$(ELF) --flash= --boot=$(DBL_QUOTE)$(shell $(DBL_QUOTE)$(QUARTUS_ROOTDIR)/sopc_builder/bin/find_sopc_component_dir$(DBL_QUOTE) $(CPU_CLASS) $(QUARTUS_PROJECT_DIR))/$(BOOT_COPIER)$(DBL_QUOTE) --outfile=$(EXT_FLASH_FLASHTARGET_ALT_SIM_PREFIX)ext_flash.flash --sim_optimize=$(ALT_SIM_OPTIMIZE) --base=0x44000000 --end=0x47FFFFFF --reset=$(CPU_RESET_ADDRESS)

dummy_verifysysid_file:
	nios2-download $(JTAG_CABLE)                                --sidp=0x49102700 --id=807520620 --timestamp=1326991139
