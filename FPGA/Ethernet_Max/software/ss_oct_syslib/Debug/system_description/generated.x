 ...
 *
 * Generated: 2012-01-19 12:03:29.52
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x44000000, LENGTH = 32
    ddr2 : ORIGIN = 0x00000000, LENGTH = 1073741824
    onchip_memory_UNUSED : ORIGIN = 0x49080000, LENGTH = 32
    onchip_memory : ORIGIN = 0x49080020, LENGTH = 511968
    ext_flash : ORIGIN = 0x44000020, LENGTH = 67108832
    descriptor_memory : ORIGIN = 0x49101800, LENGTH = 2048
}

    /* Define symbols for each memory base-address */
 __alt_mem_ddr2 = 0x00000000 ;
 __alt_mem_onchip_memory = 0x49080000 ;
 __alt_mem_ext_flash = 0x44000000 ;
 __alt_mem_descriptor_memory = 0x49101800 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  onchip_memory =0x3a880100 /* NOP on Nios2 (big endian) */
...
PROVIDE( __alt_heap_limit    = 0x490fd000 );
