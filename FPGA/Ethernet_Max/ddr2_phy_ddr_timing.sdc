...
set input_max_delay   [round_3dp [expr -$::t(DQS_PSERR) - $DQSpathjitter*$DQSpathjitter_setup_prop       + $::t(min_additional_dqs_variation) - $fpga_tREAD_CAPTURE_SETUP_ERROR]]
set input_min_delay   [round_3dp [expr  $::t(DQS_PSERR) + $DQSpathjitter*(1.0-$DQSpathjitter_setup_prop) + $::t(max_additional_dqs_variation) + $fpga_tREAD_CAPTURE_HOLD_ERROR - 0.5*$::t(period) + $::t(QHS) + $tJITper]]
