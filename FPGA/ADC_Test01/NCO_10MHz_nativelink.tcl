...
set ipfs_ext "vo"
if {[file exists NCO_10MHz.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find NCO_10MHz.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NCO_10MHz_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.NCO_10MHz_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "NCO_10MHz.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "NCO_10MHz_tb.${hdl_ext}" -section_id tb -library work
