// megafunction wizard: %FFT v9.1%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			asj_fft_sglstream_fft_91
// ============================================================
// Generated by FFT 9.1 [Altera, IP Toolbench 1.3.0 Build 350]
// ************************************************************
...
module fft_Aline (
	...
	asj_fft_sglstream_fft_91	asj_fft_sglstream_fft_91_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_sglstream_fft_91_inst.nps = 1024,
		asj_fft_sglstream_fft_91_inst.bfp = 1,
		asj_fft_sglstream_fft_91_inst.nume = 1,
		asj_fft_sglstream_fft_91_inst.mpr = 16,
		asj_fft_sglstream_fft_91_inst.twr = 16,
		asj_fft_sglstream_fft_91_inst.bpr = 16,
		asj_fft_sglstream_fft_91_inst.bpb = 4,
		asj_fft_sglstream_fft_91_inst.fpr = 4,
		asj_fft_sglstream_fft_91_inst.mram = 0,
		asj_fft_sglstream_fft_91_inst.m512 = 0,
		asj_fft_sglstream_fft_91_inst.mult_type = 1,
		asj_fft_sglstream_fft_91_inst.mult_imp = 0,
		asj_fft_sglstream_fft_91_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_sglstream_fft_91_inst.rfs1 = "fft_Aline_1n1024sin.hex",
		asj_fft_sglstream_fft_91_inst.rfs2 = "fft_Aline_2n1024sin.hex",
		asj_fft_sglstream_fft_91_inst.rfs3 = "fft_Aline_3n1024sin.hex",
		asj_fft_sglstream_fft_91_inst.rfc1 = "fft_Aline_1n1024cos.hex",
		asj_fft_sglstream_fft_91_inst.rfc2 = "fft_Aline_2n1024cos.hex",
		asj_fft_sglstream_fft_91_inst.rfc3 = "fft_Aline_3n1024cos.hex";
endmodule
...
// Retrieval info: <MEGACORE title="FFT MegaCore Function"  version="9.1"  build="350"  iptb_version="1.3.0 Build 350"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_sglstream_fft_91" >
...
// Retrieval info:      <PRIVATE name = "DEVICE" value="Stratix IV"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="4523"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fft_Aline.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="fft_Aline_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
