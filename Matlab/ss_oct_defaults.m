...
% Name of the subject
ssOCTdefaults.folders.subjectID         = 'NO_NAME';
% Description of the experiment
ssOCTdefaults.folders.expID             = 'EMPTY';
...
% Number of bytes per A-line (2368) > NSAMPLES*2=2340. Has to be divisible by 32
...
% Maximize figure
ssOCTdefaults.GUI.screenSize            = get(0,'Screensize');
ssOCTdefaults.GUI.screenSize            = [ssOCTdefaults.GUI.screenSize(3)/2  0.0370 ...
    ssOCTdefaults.GUI.screenSize(3)/2 ...
    ssOCTdefaults.GUI.screenSize(4)- 0.0370];

% Correct B-scan in real-time acquisition
