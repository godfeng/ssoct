...
set ipfs_ext "vo"
if {[file exists nc0_10mhz.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find nc0_10mhz.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME nc0_10mhz_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.nc0_10mhz_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "nc0_10mhz.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "nc0_10mhz_tb.${hdl_ext}" -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_RUN_SIM_FOR "22000 ns" -section_id tb -library work
