...
set ipfs_ext "vo"
if {[file exists nco_1mhz.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find nco_1mhz.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME nco_1mhz_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.nco_1mhz_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "nco_1mhz.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "nco_1mhz_tb.${hdl_ext}" -section_id tb -library work
