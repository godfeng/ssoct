...
add wave -noupdate -format Logic /nco_1mhz_tb/clk
add wave -noupdate -format Logic /nco_1mhz_tb/reset_n
add wave -noupdate -format Logic /nco_1mhz_tb/clken
add wave -noupdate -format Literal -radix unsigned /nco_1mhz_tb/phi
add wave -noupdate -divider -height 50 {New Divider}
add wave -noupdate -format Logic /nco_1mhz_tb/out_valid
